...
public class ActivityOptionsCompat {
    ...
    public static ActivityOptionsCompat makeSceneTransitionAnimation(Activity activity, android.support.v4.util.Pair<View, String> ... arrpair) {
        if (Build.VERSION.SDK_INT >= 21) {
            Pair[] arrpair2 = null;
            if (arrpair != null) {
            ...
            return ActivityOptionsCompat.createImpl(ActivityOptions.makeSceneTransitionAnimation((Activity)activity, arrpair2));
        }
        return new ActivityOptionsCompat();
    }
