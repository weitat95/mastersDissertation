...
public final class GestureDetectorCompat {
    ...
    implements GestureDetectorCompatImpl {
        ...
        private boolean isConsideredDoubleTap(MotionEvent motionEvent, MotionEvent motionEvent2, MotionEvent motionEvent3) {
            int n;
            int n2;
            return this.mAlwaysInBiggerTapRegion && motionEvent3.getEventTime() - motionEvent2.getEventTime() <= (long)DOUBLE_TAP_TIMEOUT && (n2 = (int)motionEvent.getX() - (int)motionEvent3.getX()) * n2 + (n = (int)motionEvent.getY() - (int)motionEvent3.getY()) * n < this.mDoubleTapSlopSquare;
        }
        ...
        public boolean onTouchEvent(MotionEvent var1_1) {
            ...
            switch (var10_2 & 255) {
                ...
                case 6: {
                    ...
                    var7_4 = var1_1.getActionIndex();
                    var6_3 = var1_1.getPointerId(var7_4);
                    var2_6 = this.mVelocityTracker.getXVelocity(var6_3);
                    var3_5 = this.mVelocityTracker.getYVelocity(var6_3);
                    var6_3 = 0;
                    do {
                        var12_12 = var11_11;
                        if (var6_3 >= var9_7) return var12_12;
                        if (var6_3 != var7_4 && var2_6 * this.mVelocityTracker.getXVelocity(var8_8 = var1_1.getPointerId(var6_3)) + var3_5 * this.mVelocityTracker.getYVelocity(var8_8) < 0.0f) {
...
lbl122:
                    // 1 sources
                    if (!this.mInLongPress) ** GOTO lbl127
                    this.mHandler.removeMessages(3);
                    this.mInLongPress = false;
                    var11_11 = var14_10;
                    ** GOTO lbl145
lbl127:
                    // 1 sources
                    if (!this.mAlwaysInTapRegion) ** GOTO lbl136
...
lbl136:
                    ...
                    var2_6 = var16_16.getYVelocity(var6_3);
                    var3_5 = var16_16.getXVelocity(var6_3);
                    if (Math.abs(var2_6) > (float)this.mMinimumFlingVelocity) ** GOTO lbl144
                    var11_11 = var14_10;
                    if (!(Math.abs(var3_5) > (float)this.mMinimumFlingVelocity)) ** GOTO lbl145
lbl144:
                    // 2 sources
