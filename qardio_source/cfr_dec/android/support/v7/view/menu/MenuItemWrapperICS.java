...
implements MenuItem {
    ...
    public MenuItem setActionProvider(android.view.ActionProvider object) {
        ...
        if (object != null) {
            ActionProviderWrapper actionProviderWrapper = this.createActionProviderWrapper((android.view.ActionProvider)object);
        } else {
            Object var1_4 = null;
        }
        supportMenuItem.setSupportActionProvider((ActionProvider)var1_3);
        return this;
    }
