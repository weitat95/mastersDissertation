    ...
    implements DataFetcher<ImageVideoWrapper> {
        ...
        public ImageVideoWrapper loadData(Priority priority) throws Exception {
                ...
                if (this.streamFetcher != null) {
                    try {
                        ...
                        if (Log.isLoggable((String)"IVML", (int)2)) {
                            Log.v((String)"IVML", (String)"Exception fetching input stream, trying ParcelFileDescriptor", (Throwable)exception);
                        }
            ...
            try {
                ...
                if (Log.isLoggable((String)"IVML", (int)2)) {
                    Log.v((String)"IVML", (String)"Exception fetching ParcelFileDescriptor", (Throwable)exception);
                }
