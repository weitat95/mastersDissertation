...
extends GlideDrawable {
    ...
    GlideBitmapDrawable(Resources resources, BitmapState bitmapState) {
        ...
        if (resources != null) {
            ...
            bitmapState.targetDensity = n;
        } else {
            n = bitmapState.targetDensity;
        }
        this.width = bitmapState.bitmap.getScaledWidth(n);
        this.height = bitmapState.bitmap.getScaledHeight(n);
    }
    ...
    public void setAlpha(int n) {
        if (this.state.paint.getAlpha() != n) {
            this.state.setAlpha(n);
            this.invalidateSelf();
        }
    }
