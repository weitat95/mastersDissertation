...
implements Transformation<GifDrawable> {
    ...
    @Override
    public Resource<GifDrawable> transform(Resource<GifDrawable> gifDrawableResource, int n, int n2) {
        ...
        if (!(bitmapResource = this.wrapped.transform(bitmapResource, n, n2).get()).equals((Object)bitmap)) {
