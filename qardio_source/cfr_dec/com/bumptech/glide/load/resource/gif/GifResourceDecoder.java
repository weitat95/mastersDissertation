...
implements ResourceDecoder<InputStream, GifDrawable> {
     ...
     */
    private GifDrawableResource decode(byte[] arrby, int n, int n2, GifHeaderParser object, GifDecoder gifDecoder) {
        if (((GifHeader)(object = ((GifHeaderParser)object).parseHeader())).getNumFrames() <= 0 || ((GifHeader)object).getStatus() != 0 || (gifDecoder = this.decodeFirstFrame(gifDecoder, (GifHeader)object, arrby)) == null) {
            return null;
        }
        UnitTransformation<Bitmap> unitTransformation = UnitTransformation.get();
        return new GifDrawableResource(new GifDrawable(this.context, this.provider, this.bitmapPool, unitTransformation, n, n2, (GifHeader)object, arrby, (Bitmap)gifDecoder));
    }
    ...
    private static byte[] inputStreamToBytes(InputStream inputStream) {
        ...
        try {
            ...
            Log.w((String)"GifResourceDecoder", (String)"Error reading data from stream", (Throwable)iOException);
    ...
    public GifDrawableResource decode(InputStream object, int n, int n2) {
        ...
        try {
            object2 = this.decode((byte[])object2, n, n2, (GifHeaderParser)object, gifDecoder);
            return object2;
        }
        finally {
