...
implements ResourceEncoder<GifBitmapWrapper> {
    ...
    public boolean encode(Resource<GifBitmapWrapper> object, OutputStream outputStream) {
        Resource<Bitmap> resource = ((GifBitmapWrapper)(object = object.get())).getBitmapResource();
        if (resource != null) {
            return this.bitmapEncoder.encode((Bitmap)resource, outputStream);
        }
        return this.gifEncoder.encode((GifDrawable)((Object)((GifBitmapWrapper)object).getGifResource()), outputStream);
    }
