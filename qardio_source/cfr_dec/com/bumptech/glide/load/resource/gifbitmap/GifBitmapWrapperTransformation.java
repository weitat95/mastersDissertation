...
implements Transformation<GifBitmapWrapper> {
     ...
     */
    @Override
    public Resource<GifBitmapWrapper> transform(Resource<GifBitmapWrapper> gifBitmapWrapperResource, int n, int n2) {
        ...
        if (resource != null && this.bitmapTransformation != null) {
            resource2 = this.bitmapTransformation.transform(resource, n, n2);
        ...
        Resource<GifDrawable> resource3 = this.gifDataTransformation.transform(resource2, n, n2);
        gifBitmapWrapperResource2 = gifBitmapWrapperResource;
