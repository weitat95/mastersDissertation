...
class SessionMetadataCollector {
    ...
    public SessionMetadataCollector(Context context, IdManager idManager, String string2, String string3) {
    ...
    public SessionEventMetadata getMetadata() {
        ...
        String string4 = object.get((Object)IdManager.DeviceIdentifierType.ANDROID_ID);
        String string5 = object.get((Object)IdManager.DeviceIdentifierType.ANDROID_ADVERTISING_ID);
