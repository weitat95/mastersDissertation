...
class MetaDataStore {
    ...
    public Map<String, String> readKeyData(String var1_1) {
        ...
        return var1_1;
            ...
            var1_1 = var2_3;
            try {
                Fabric.getLogger().e("CrashlyticsCore", "Error deserializing user metadata.", var3_5);
            }
    ...
    public void writeKeyData(String var1_1, Map<String, String> var2_3) {
        ...
        var3_7 = null;
        var1_1 = var4_6;
        var6_10 = MetaDataStore.keysDataToJson((Map<String, String>)var2_3);
        var1_1 = var4_6;
        ...
        return;
            ...
            var1_1 = var2_3;
            try {
                Fabric.getLogger().e("CrashlyticsCore", "Error serializing key/value metadata.", var3_7);
            }
            catch (Throwable var2_4) lbl-1000:
            // 2 sources
            {
