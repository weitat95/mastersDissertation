...
public class GetModeCommand
extends BaseEngineeringCommand {
    private final int mUserId;

    public GetModeCommand(BluetoothGatt bluetoothGatt, int n) {
        super(bluetoothGatt);
        this.mUserId = n;
    }
    ...
    @Override
    public void execute() {
        this.writeToEngineering(this.createCommandWithUserId(this.createCommand(22), this.mUserId));
    }
