...
final class RxHeartRateApi$$Lambda$1
implements SingleOnSubscribe {
    private final GoogleApiClient arg$1;
    private final DataSet arg$2;
    private final DataSource arg$3;

    private RxHeartRateApi$$Lambda$1(GoogleApiClient googleApiClient, DataSet dataSet, DataSource dataSource) {
    ...
    public static SingleOnSubscribe lambdaFactory$(GoogleApiClient googleApiClient, DataSet dataSet, DataSource dataSource) {
        return new RxHeartRateApi$$Lambda$1(googleApiClient, dataSet, dataSource);
    }

    @LambdaForm.Hidden
    public void subscribe(SingleEmitter singleEmitter) {
        RxHeartRateApi.lambda$saveHeartRateToGoogleFit$1(this.arg$1, this.arg$2, this.arg$3, singleEmitter);
    }
}
