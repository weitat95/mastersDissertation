...
final class RxHeartRateApi$$Lambda$11
implements ResultCallback {
    private final DataSource arg$1;
    private final SingleEmitter arg$2;

    private RxHeartRateApi$$Lambda$11(DataSource dataSource, SingleEmitter singleEmitter) {
    ...
    public static ResultCallback lambdaFactory$(DataSource dataSource, SingleEmitter singleEmitter) {
        return new RxHeartRateApi$$Lambda$11(dataSource, singleEmitter);
    }

    @LambdaForm.Hidden
    public void onResult(Result result) {
        RxHeartRateApi.lambda$null$0(this.arg$1, this.arg$2, (Status)result);
    }
}
