...
final class RxHeartRateApi$$Lambda$3
implements SingleOnSubscribe {
    ...
    private RxHeartRateApi$$Lambda$3(GoogleApiClient googleApiClient, DataSet dataSet, DataSource dataSource, List list) {
    ...
    public static SingleOnSubscribe lambdaFactory$(GoogleApiClient googleApiClient, DataSet dataSet, DataSource dataSource, List list) {
        return new RxHeartRateApi$$Lambda$3(googleApiClient, dataSet, dataSource, list);
    }

    @LambdaForm.Hidden
    public void subscribe(SingleEmitter singleEmitter) {
        RxHeartRateApi.lambda$saveHeartRateToGoogleFit$4(this.arg$1, this.arg$2, this.arg$3, this.arg$4, singleEmitter);
    }
}
