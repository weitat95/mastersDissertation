...
final class QBOnboardingManager$$Lambda$3
implements Runnable {
    private final QBOnboardingManager arg$1;

    private QBOnboardingManager$$Lambda$3(QBOnboardingManager qBOnboardingManager) {
        this.arg$1 = qBOnboardingManager;
    }

    public static Runnable lambdaFactory$(QBOnboardingManager qBOnboardingManager) {
        return new QBOnboardingManager$$Lambda$3(qBOnboardingManager);
    }

    @LambdaForm.Hidden
    @Override
    public void run() {
        this.arg$1.lambda$readWifiBaseScanDelayed$2();
    }
}
