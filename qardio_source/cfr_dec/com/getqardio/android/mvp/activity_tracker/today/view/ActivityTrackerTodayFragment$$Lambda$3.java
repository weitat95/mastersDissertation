...
final class ActivityTrackerTodayFragment$$Lambda$3
implements Consumer {
    private final ActivityTrackerTodayFragment arg$1;

    private ActivityTrackerTodayFragment$$Lambda$3(ActivityTrackerTodayFragment activityTrackerTodayFragment) {
    ...
    public static Consumer lambdaFactory$(ActivityTrackerTodayFragment activityTrackerTodayFragment) {
        return new ActivityTrackerTodayFragment$$Lambda$3(activityTrackerTodayFragment);
    }

    @LambdaForm.Hidden
    public void accept(Object object) {
        this.arg$1.lambda$onConnected$1((List)object);
    }
}
