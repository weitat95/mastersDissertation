...
final class ActivityTrackerTodayFragment$$Lambda$6
implements Consumer {
    private final ActivityTrackerTodayFragment arg$1;

    private ActivityTrackerTodayFragment$$Lambda$6(ActivityTrackerTodayFragment activityTrackerTodayFragment) {
    ...
    public static Consumer lambdaFactory$(ActivityTrackerTodayFragment activityTrackerTodayFragment) {
        return new ActivityTrackerTodayFragment$$Lambda$6(activityTrackerTodayFragment);
    }

    @LambdaForm.Hidden
    public void accept(Object object) {
        this.arg$1.lambda$onConnected$3((List)object);
    }
}
