...
final class FollowMeUserRepository$$Lambda$8
implements Function {
    private final FollowMeUserRepository arg$1;
    private final long arg$2;
    private final FollowMeUser arg$3;

    private FollowMeUserRepository$$Lambda$8(FollowMeUserRepository followMeUserRepository, long l, FollowMeUser followMeUser) {
    ...
    public static Function lambdaFactory$(FollowMeUserRepository followMeUserRepository, long l, FollowMeUser followMeUser) {
        return new FollowMeUserRepository$$Lambda$8(followMeUserRepository, l, followMeUser);
    }

    @LambdaForm.Hidden
    public Object apply(Object object) {
        return this.arg$1.lambda$syncDelete$9(this.arg$2, this.arg$3, (FollowMeUser)object);
    }
}
