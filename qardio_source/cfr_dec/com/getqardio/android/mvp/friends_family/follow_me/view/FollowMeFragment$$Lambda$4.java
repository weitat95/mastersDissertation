...
final class FollowMeFragment$$Lambda$4
implements Consumer {
    private final FollowMeFragment arg$1;

    private FollowMeFragment$$Lambda$4(FollowMeFragment followMeFragment) {
        this.arg$1 = followMeFragment;
    }

    public static Consumer lambdaFactory$(FollowMeFragment followMeFragment) {
        return new FollowMeFragment$$Lambda$4(followMeFragment);
    }
