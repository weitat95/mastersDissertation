...
public class DailyMeasurementListUriHandler
extends UriHandler {
    public DailyMeasurementListUriHandler(int n, SQLiteOpenHelper sQLiteOpenHelper) {
        super(n, sQLiteOpenHelper);
    }

    @Override
    protected int delete(Context context, Uri uri, String string2, String[] arrstring) {
        throw new UnsupportedOperationException("DailyMeasurementListUriHandler doesn't support delete operation");
    }

    @Override
    protected Uri insert(Context context, Uri uri, ContentValues contentValues) {
        throw new UnsupportedOperationException("DailyMeasurementListUriHandler doesn't support insert operation");
    }
    ...
    protected int update(Context context, Uri uri, ContentValues contentValues, String string2, String[] arrstring) {
        throw new UnsupportedOperationException("DailyMeasurementListUriHandler doesn't support update operation");
    }
}
