...
public class DailyWeightMeasurementListUriHandler
extends UriHandler {
    public DailyWeightMeasurementListUriHandler(int n, SQLiteOpenHelper sQLiteOpenHelper) {
        super(n, sQLiteOpenHelper);
    }

    @Override
    protected int delete(Context context, Uri uri, String string2, String[] arrstring) {
        throw new UnsupportedOperationException("DailyWeightMeasurementListUriHandler doesn't support delete operation");
    }

    @Override
    protected Uri insert(Context context, Uri uri, ContentValues contentValues) {
        throw new UnsupportedOperationException("DailyWeightMeasurementListUriHandler doesn't support insert operation");
    }
    ...
    protected Cursor query(Context context, Uri uri, String[] cursor, String string2, String[] arrstring, String string3) {
        ...
        cursor = sQLiteQueryBuilder.query(this.sqlHelper.getReadableDatabase(), (String[])cursor, string2, arrstring, "datetime(measure_date / 1000,'unixepoch','localtime','start of day')", null, string3);
    ...
    protected int update(Context context, Uri uri, ContentValues contentValues, String string2, String[] arrstring) {
        throw new UnsupportedOperationException("DailyWeightMeasurementListUriHandler doesn't support update operation");
    }
}
