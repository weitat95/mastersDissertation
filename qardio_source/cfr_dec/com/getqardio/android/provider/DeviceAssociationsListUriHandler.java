...
public class DeviceAssociationsListUriHandler
extends UriHandler {
    public DeviceAssociationsListUriHandler(int n, SQLiteOpenHelper sQLiteOpenHelper) {
    ...
    protected Uri insert(Context context, Uri uri, ContentValues contentValues) {
        ...
        return this.simpleInsert(context, "device_associations", uri, contentValues);
    }
