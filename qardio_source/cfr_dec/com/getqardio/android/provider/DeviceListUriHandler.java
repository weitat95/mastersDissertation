...
public class DeviceListUriHandler
extends UriHandler {
    public DeviceListUriHandler(int n, SQLiteOpenHelper sQLiteOpenHelper) {
        super(n, sQLiteOpenHelper);
    }

    @Override
    public int delete(Context context, Uri uri, String string2, String[] arrstring) {
        return this.simpleDelete(context, "devices", uri, string2, arrstring);
    }

    @Override
    public Uri insert(Context context, Uri uri, ContentValues contentValues) {
        return this.simpleInsert(context, "devices", uri, contentValues);
    }

    @Override
    public Cursor query(Context context, Uri uri, String[] arrstring, String string2, String[] arrstring2, String string3) {
        return this.queryFullTable(context, "devices", uri, arrstring, string2, arrstring2, string3);
    }

    @Override
    public int update(Context context, Uri uri, ContentValues contentValues, String string2, String[] arrstring) {
        return this.simpleUpdate(context, "devices", uri, contentValues, string2, arrstring);
    }
}
