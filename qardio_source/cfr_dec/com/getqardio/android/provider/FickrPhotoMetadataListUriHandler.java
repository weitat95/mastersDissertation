...
public class FickrPhotoMetadataListUriHandler
extends UriHandler {
    public FickrPhotoMetadataListUriHandler(int n, SQLiteOpenHelper sQLiteOpenHelper) {
    ...
    public Uri insert(Context context, Uri uri, ContentValues contentValues) {
        return this.simpleInsert(context, "flickr_photo_metadata", uri, contentValues);
    }
