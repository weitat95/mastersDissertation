...
public class FollowingMetadataListUriHandler
extends UriHandler {
    public FollowingMetadataListUriHandler(int n, SQLiteOpenHelper sQLiteOpenHelper) {
    ...
    public int delete(Context context, Uri uri, String string2, String[] arrstring) {
        ...
        StringBuilder stringBuilder = new StringBuilder().append("user_id=").append((String)uri.getPathSegments().get(4));
    ...
    public Uri insert(Context context, Uri uri, ContentValues contentValues) {
        return this.simpleInsert(context, "following_metadata", uri, contentValues);
    }
