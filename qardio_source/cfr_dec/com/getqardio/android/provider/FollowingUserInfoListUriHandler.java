...
public class FollowingUserInfoListUriHandler
extends UriHandler {
    public FollowingUserInfoListUriHandler(int n, SQLiteOpenHelper sQLiteOpenHelper) {
    ...
    public Uri insert(Context context, Uri uri, ContentValues contentValues) {
        ...
        return this.simpleInsert(context, "following_user_info", uri, contentValues);
    }
