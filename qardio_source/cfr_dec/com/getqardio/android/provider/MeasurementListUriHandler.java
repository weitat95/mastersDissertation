...
public class MeasurementListUriHandler
extends UriHandler {
    public MeasurementListUriHandler(int n, SQLiteOpenHelper sQLiteOpenHelper) {
    ...
    public Uri insert(Context context, Uri uri, ContentValues contentValues) {
        ...
        return this.simpleInsert(context, "measurements", uri, contentValues);
    }
