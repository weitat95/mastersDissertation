...
public class MeasurementsHistoryItemUriHandler
extends UriHandler {
    public MeasurementsHistoryItemUriHandler(int n, SQLiteOpenHelper sQLiteOpenHelper) {
        super(n, sQLiteOpenHelper);
    }

    @Override
    protected int delete(Context context, Uri uri, String string2, String[] arrstring) {
        return this.simpleDelete(context, "measurements_history", uri, string2, arrstring);
    }

    @Override
    protected Uri insert(Context context, Uri uri, ContentValues contentValues) {
        throw new UnsupportedOperationException("MeasurementsHistoryItemUriHandler does not support insert operation");
    }
