...
public class NotesListUriHandler
extends UriHandler {
    public NotesListUriHandler(int n, SQLiteOpenHelper sQLiteOpenHelper) {
    ...
    public Uri insert(Context context, Uri uri, ContentValues contentValues) {
        ...
        return this.simpleInsert(context, "notes", uri, contentValues);
    }
