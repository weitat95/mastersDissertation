...
public class NotificationTokensItemUriHandler
extends UriHandler {
    public NotificationTokensItemUriHandler(int n, SQLiteOpenHelper sQLiteOpenHelper) {
    ...
    protected int delete(Context context, Uri uri, String string2, String[] arrstring) {
        ...
        StringBuilder stringBuilder = new StringBuilder().append("device_token= '").append(uri.getLastPathSegment()).append("' AND ").append("user_id").append("=").append((String)uri.getPathSegments().get(1));
    ...
    protected int update(Context context, Uri uri, ContentValues contentValues, String string2, String[] arrstring) {
        ...
        string2 = stringBuilder.append(string2).toString();
        if (bl) {
            return this.simpleUpdate(context, "notifications_device_tokens", uri, contentValues, string2, arrstring);
        }
        arrstring = null;
        return this.simpleUpdate(context, "notifications_device_tokens", uri, contentValues, string2, arrstring);
    }
