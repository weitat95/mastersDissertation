...
public class PregnancyModeDataListUriHandler
extends UriHandler {
    public PregnancyModeDataListUriHandler(int n, SQLiteOpenHelper sQLiteOpenHelper) {
    ...
    public Uri insert(Context context, Uri uri, ContentValues contentValues) {
        ...
        return this.simpleInsert(context, "pregnancy_mode_data", uri, contentValues);
    }
