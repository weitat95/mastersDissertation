...
public class ReminderListUriHandler
extends UriHandler {
    public ReminderListUriHandler(int n, SQLiteOpenHelper sQLiteOpenHelper) {
    ...
    public Uri insert(Context context, Uri uri, ContentValues contentValues) {
        ...
        return this.simpleInsert(context, "reminders", uri, contentValues);
    }
