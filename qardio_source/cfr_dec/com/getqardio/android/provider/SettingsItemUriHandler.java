...
public class SettingsItemUriHandler
extends UriHandler {
    public SettingsItemUriHandler(int n, SQLiteOpenHelper sQLiteOpenHelper) {
    ...
    public int delete(Context context, Uri uri, String string2, String[] arrstring) {
        ...
        if (bl) {
            return this.simpleDelete(context, "settings", uri, string2, arrstring);
        }
        arrstring = null;
        return this.simpleDelete(context, "settings", uri, string2, arrstring);
    }
    ...
    public Uri insert(Context context, Uri uri, ContentValues contentValues) {
        ...
        return this.simpleInsert(context, "settings", uri, contentValues);
    }
    ...
    public Cursor query(Context context, Uri uri, String[] arrstring, String string2, String[] arrstring2, String string3) {
        ...
        string2 = stringBuilder.append(string2).toString();
        if (bl) {
            return this.queryFullTable(context, "settings", uri, arrstring, string2, arrstring2, string3);
        }
        arrstring2 = null;
        return this.queryFullTable(context, "settings", uri, arrstring, string2, arrstring2, string3);
    }
    ...
    public int update(Context context, Uri uri, ContentValues contentValues, String string2, String[] arrstring) {
        ...
        string2 = stringBuilder.append(string2).toString();
        if (bl) {
            return this.simpleUpdate(context, "settings", uri, contentValues, string2, arrstring);
        }
        arrstring = null;
        return this.simpleUpdate(context, "settings", uri, contentValues, string2, arrstring);
    }
