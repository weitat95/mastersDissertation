...
public class SupportTicketsListUriHandler
extends UriHandler {
    public SupportTicketsListUriHandler(int n, SQLiteOpenHelper sQLiteOpenHelper) {
        super(n, sQLiteOpenHelper);
    }

    @Override
    protected int delete(Context context, Uri uri, String string2, String[] arrstring) {
        throw new UnsupportedOperationException("SupportTicketsListUriHandler does not support delete operation");
    }

    @Override
    protected Uri insert(Context context, Uri uri, ContentValues contentValues) {
        return this.simpleInsert(context, "support_tickets", uri, contentValues);
    }
    ...
    protected int update(Context context, Uri uri, ContentValues contentValues, String string2, String[] arrstring) {
        throw new UnsupportedOperationException("SupportTicketsListUriHandler does not support update operation");
    }
}
