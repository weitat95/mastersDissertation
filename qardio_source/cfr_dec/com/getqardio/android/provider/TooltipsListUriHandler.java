...
public class TooltipsListUriHandler
extends UriHandler {
    public TooltipsListUriHandler(int n, SQLiteOpenHelper sQLiteOpenHelper) {
        super(n, sQLiteOpenHelper);
    }

    @Override
    protected int delete(Context context, Uri uri, String string2, String[] arrstring) {
        throw new UnsupportedOperationException("TooltipsListUriHandler does not support delete operation");
    }

    @Override
    protected Uri insert(Context context, Uri uri, ContentValues contentValues) {
        return this.simpleInsert(context, "tooltips", uri, contentValues);
    }

    @Override
    protected Cursor query(Context context, Uri uri, String[] arrstring, String string2, String[] arrstring2, String string3) {
        return this.queryFullTable(context, "tooltips", uri, arrstring, string2, arrstring2, string3);
    }

    @Override
    protected int update(Context context, Uri uri, ContentValues contentValues, String string2, String[] arrstring) {
        throw new UnsupportedOperationException("TooltipsListUriHandler does not support update operation");
    }
}
