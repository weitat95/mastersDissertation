...
public class VisitorMeasurementsListUriHandler
extends UriHandler {
    public VisitorMeasurementsListUriHandler(int n, SQLiteOpenHelper sQLiteOpenHelper) {
    ...
    protected Uri insert(Context context, Uri uri, ContentValues contentValues) {
        ...
        return this.simpleInsert(context, "visitor_measurements", uri, contentValues);
    }
