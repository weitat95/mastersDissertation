...
public class WeightMeasurementListUriHandler
extends UriHandler {
    public WeightMeasurementListUriHandler(int n, SQLiteOpenHelper sQLiteOpenHelper) {
    ...
    public Uri insert(Context context, Uri uri, ContentValues contentValues) {
        ...
        return this.simpleInsert(context, "weight_measurements", uri, contentValues);
    }
