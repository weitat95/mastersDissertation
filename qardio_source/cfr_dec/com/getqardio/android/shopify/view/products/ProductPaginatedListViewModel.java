...
import com.getqardio.android.shopify.view.products.ProductPaginatedListViewModel$$Lambda$1;
import com.getqardio.android.shopify.view.products.ProductPaginatedListViewModel$$Lambda$2;
...
public class ProductPaginatedListViewModel
extends BasePaginatedListViewModel<Product> {
    ...
    public ProductPaginatedListViewModel(String string2) {
    ...
    /* synthetic */ ObservableSource lambda$nextPageRequestComposer$1(Observable observable) {
        return observable.flatMapSingle(ProductPaginatedListViewModel$$Lambda$2.lambdaFactory$(this));
    }
    ...
    protected ObservableTransformer<String, List<Product>> nextPageRequestComposer() {
        return ProductPaginatedListViewModel$$Lambda$1.lambdaFactory$(this);
    }
}
