...
public final class ImageGalleryView$PagerListItemModel$ItemViewHolder_ViewBinding
implements Unbinder {
    private ImageGalleryView.PagerListItemModel.ItemViewHolder target;
    private View view2131820710;

    public ImageGalleryView$PagerListItemModel$ItemViewHolder_ViewBinding(final ImageGalleryView.PagerListItemModel.ItemViewHolder itemViewHolder, View view) {
    ...
    public void unbind() {
        ImageGalleryView.PagerListItemModel.ItemViewHolder itemViewHolder = this.target;
