...
final class AddBPManualMeasurementFragment$$Lambda$5
implements View.OnFocusChangeListener {
    private final AddBPManualMeasurementFragment arg$1;

    private AddBPManualMeasurementFragment$$Lambda$5(AddBPManualMeasurementFragment addBPManualMeasurementFragment) {
    ...
    public static View.OnFocusChangeListener lambdaFactory$(AddBPManualMeasurementFragment addBPManualMeasurementFragment) {
        return new AddBPManualMeasurementFragment$$Lambda$5(addBPManualMeasurementFragment);
    }

    @LambdaForm.Hidden
    public void onFocusChange(View view, boolean bl) {
        this.arg$1.lambda$init$4(view, bl);
    }
}
