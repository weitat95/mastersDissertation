...
final class AddBPManualMeasurementFragment$$Lambda$7
implements View.OnFocusChangeListener {
    private final AddBPManualMeasurementFragment arg$1;

    private AddBPManualMeasurementFragment$$Lambda$7(AddBPManualMeasurementFragment addBPManualMeasurementFragment) {
    ...
    public static View.OnFocusChangeListener lambdaFactory$(AddBPManualMeasurementFragment addBPManualMeasurementFragment) {
        return new AddBPManualMeasurementFragment$$Lambda$7(addBPManualMeasurementFragment);
    }

    @LambdaForm.Hidden
    public void onFocusChange(View view, boolean bl) {
        this.arg$1.lambda$init$6(view, bl);
    }
}
