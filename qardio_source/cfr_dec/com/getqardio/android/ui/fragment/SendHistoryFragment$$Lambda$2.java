...
final class SendHistoryFragment$$Lambda$2
implements View.OnFocusChangeListener {
    private final SendHistoryFragment arg$1;

    private SendHistoryFragment$$Lambda$2(SendHistoryFragment sendHistoryFragment) {
    ...
    public static View.OnFocusChangeListener lambdaFactory$(SendHistoryFragment sendHistoryFragment) {
        return new SendHistoryFragment$$Lambda$2(sendHistoryFragment);
    }

    @LambdaForm.Hidden
    public void onFocusChange(View view, boolean bl) {
        this.arg$1.lambda$onActivityCreated$1(view, bl);
    }
}
