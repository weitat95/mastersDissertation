...
final class StartBPFragment$$Lambda$5
implements ValueAnimator.AnimatorUpdateListener {
    private final StartBPFragment arg$1;
    private final ViewGroup.LayoutParams arg$2;

    private StartBPFragment$$Lambda$5(StartBPFragment startBPFragment, ViewGroup.LayoutParams layoutParams) {
    ...
    public static ValueAnimator.AnimatorUpdateListener lambdaFactory$(StartBPFragment startBPFragment, ViewGroup.LayoutParams layoutParams) {
        return new StartBPFragment$$Lambda$5(startBPFragment, layoutParams);
    }

    @LambdaForm.Hidden
    public void onAnimationUpdate(ValueAnimator valueAnimator) {
        this.arg$1.lambda$showVisitorModeLabel$4(this.arg$2, valueAnimator);
    }
}
