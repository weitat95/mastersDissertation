...
final class zzk
extends zzbr {
    private static final String ID = zzbg.zzhx.toString();
    ...
    public final zzbs zzv(Map<String, zzbs> object) {
        try {
            object = zzgk.zzam(this.mContext.getPackageManager().getPackageInfo((String)this.mContext.getPackageName(), (int)0).versionCode);
            return object;
        }
