...
implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> object) {
        Type[] arrtype = ((TypeToken)object).getType();
        ...
        return new Adapter(gson, arrtype[0], typeAdapter, arrtype[1], typeAdapter2, (ObjectConstructor<Map<?, ?>>)object);
    }
    ...
    extends TypeAdapter<Map<K, V>> {
        ...
        public void write(JsonWriter jsonWriter, Map<K, V> iterator) throws IOException {
            ...
            for (Map.Entry entry : iterator.entrySet()) {
                ...
                int n2 = jsonElement.isJsonArray() || jsonElement.isJsonObject() ? 1 : 0;
                n |= n2;
            }
            if (n != 0) {
