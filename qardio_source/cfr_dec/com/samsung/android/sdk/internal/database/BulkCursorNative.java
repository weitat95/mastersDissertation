...
import com.samsung.android.sdk.internal.database.a;
...
implements IBulkCursor {
    ...
    public static IBulkCursor asInterface(IBinder iBinder) {
        ...
        IBulkCursor iBulkCursor2 = iBulkCursor = (IBulkCursor)iBinder.queryLocalInterface("android.content.IBulkCursor");
        if (iBulkCursor != null) return iBulkCursor2;
