...
public enum DisposableHelper implements Disposable
{
    ...
    public static boolean dispose(AtomicReference<Disposable> object) {
        ...
        Disposable disposable = ((AtomicReference)object).get();
        if (disposable != (disposableHelper = DISPOSED) && (object = ((AtomicReference)object).getAndSet((Disposable)disposableHelper)) != disposableHelper) {
            if (object != null) {
                object.dispose();
            }
            return true;
